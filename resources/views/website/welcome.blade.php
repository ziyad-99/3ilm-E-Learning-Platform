        ...
        <section class="flex flex-wrap widthfull pt-6">
            <div class="order-2 md:order-1 w-full lg:w-7/12">
                <h1 class=" mt-16 text-black text-3xl md:text-5xl font-bold leading-[112%] lg:leading-[120%] lg:text-6xl">
                    ...
                    {{--                    <span--}}
                    {{--                        class="text-orange block">{{ trans('website/welcome.souf_academy') }}</span>--}}
                ...
                @if(auth('admin')->check())
                    ...
                    <a href="{{ route('dashboard.admin') }}"
                       class=" w-40 btn items-center justify-center bg-orange border border-orange  hover:text-orange hover:bg-orange3 transform hover:scale-[1.01] transition-all flex px-6">
