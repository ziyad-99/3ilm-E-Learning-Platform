...
@section('title')
    {{ trans('admin/admin.AddSupportingCourse') }}
@endsection
    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>{{ trans('admin/admin.AddSupportingCourse') }}</span>
            </h4>
                    ...
                    <div class="w-full flex flex-wrap ">
                        ...
                        <div class=" w-full md:w-6/12 ">
                            <div class=" flex-wrap flex w-full">
                                ...
                                <div class=" w-full mt-4" id="secondary_school_specialties" style="display: none;">
                                ...
                                <script>
                                    ...
                                    var secondary_school_specialties = document.getElementById('secondary_school_specialties');
                                    ...
                                    levelSelect.addEventListener('change', function () {
                                        if (this.value === 'High School') {
                                            ...
                                            secondary_school_specialties.style.display = 'block';
                                            secondary_school_specialties.setAttribute('required', 'required');
                                        } else {
                                            highSchoolSelect.style.display = 'none';
                                            yearSelect.removeAttribute('required');
                                            yearSelect.value = "";

                                            secondary_school_specialties.style.display = 'none';
                                            secondary_school_specialties.removeAttribute('required');
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="status" required>
                                        ...
                                        <option value="0">{{ trans('admin/admin.Disabled') }}</option>
