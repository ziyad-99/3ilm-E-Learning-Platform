...
@section('title')
    {{ trans('admin/admin.SupportingCoursesPanel') }}
@endsection
    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl lg:leading-[120%] ">
                <span>    {{ trans('admin/admin.SupportingCoursesPanel') }}</span>
            </h4>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="md:w-8/12 flex gap-2">
                                ...
                                <div class="md:w-2/12 gap-2" id="secondary_school_branches_1asYear"
                                     style="display: none;">
                                    <select class="inputtext" name="branch" id="secondary_school_branches_1asYearValue">
                                        <option value="" selected
                                                disabled>{{ trans('admin/admin.selectBranch') }}</option>
                                ...
                                <div class="md:w-2/12 gap-2" id="secondary_school_branches_2as_3asYear"
                                     style="display: none;">
                                    <select class="inputtext" name="branch"
                                        ...
                                        <option
                                            value="Foreign Languages">{{ trans('admin/admin.ForeignLanguages') }}</option>
                                        <option
            ...
            @can('add_supporting_courses')
                <a href="{{ route('admin.addSupportingCourse') }}"
                   class=" btn items-center mt-5 justify-center hover:bg-orange3 transition-all	 transform hover:scale-[1.01] flex px-6">
                    <span class=" text-white font-bold text-sm ">{{ trans('admin/admin.AddSupportingCourse') }}</span>
                </a>
            @endcan
        </div>
            ...
            <div id="ajax_search_result">
                <table class="table admin" datatable id="datatable-search-list">
                    ...
                    <tr class="bg-orange/30">
                        ...
                        <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/admin.Title') }}</th>
                        <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/admin.Instructor') }}</th>
                        <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/admin.Level') }}</th>
                        <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/admin.year') }}</th>
                        <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/admin.branch') }}</th>
                        ...
                        <tr>
                            ...
                            <td class="text-sm font-normal text-black34 fontp leading-normal">
                                <div class=" w-full mt-4">
                                    @can('change_status_supporting_courses')
                                        <form
                                            action="{{ route('admin.activeOrDisableCourse', ['courseType' => 'supCourse', 'course_id' => $course->id]) }}"
                                            method="post">
                                            @csrf
                                            <select class="inputtext " name="status" onchange="this.form.submit()">
                                                ...
                                                <option
                                                    value="0" {{ $course->status == 0 ? 'selected' : ''}}>
                            ...
                            <td class="text-sm font-normal leading-normal">
                                <div class="relative text-sm group justify-end gap-2 flex font-semibold ">
                                    ...
                                    @can('delete_supporting_courses')
                                        <a id="deleteCourse"
                                           href="{{ route('admin.deleteSupportingCourse', ['course_id'=>$course->id]) }}"
    ...
    <script>
        $(document).ready(function () {
            $('form').submit(function (event) {
                ...
                $.ajax({
                    url: "{{ route('admin.ajaxFilterCourse') }}", // Get the form's action attribute
