...
@section('title')
    {{ trans('admin/admin.EditLanguagesCourse') }}
@endsection
    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>{{ trans('admin/admin.EditLanguagesCourse') }}</span>
            </h4>
            ...
            <form class="w-full" action="{{ route('admin.updateLanguageCourse') }}" method="post"
                ...
                @csrf
                <input hidden name="inten_course_id" value="{{ $lang_course->id }}" required/>
                    ...
                    <div class="w-full flex flex-wrap ">
                        ...
                        <div class=" w-full mt-4">
                            ...
                            <input class="inputtext fontp" name="title_en"
                                   value="{{ $lang_course->getTranslations()['title']['en'] }}" required
                        ...
                        <div class=" w-full mt-4">
                            ...
                            <input class="inputtext fontp" name="title_ar"
                                   value="{{ $lang_course->getTranslations()['title']['ar'] }}" required
                        ...
                        <div class=" w-full mt-4">
                            ...
                            <input class="inputtext fontp" name="title_fr"
                                   value="{{ $lang_course->getTranslations()['title']['fr'] }}" required
                            ...
                            <div class=" flex-wrap flex w-full">
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="instructor_id" required>
                                        ...
                                        <option selected
                                                value="{{ $lang_course->instructor->id }}">{{ $lang_course->instructor->firstName }}</option>
                                    ...
                                    <div style="margin-right: 20px; margin-bottom: 20px;">
                                        <label class="containerRadio">
                                            ...
                                            <input type="radio" name="paymentType" value="percentage"
                                                   required {{ $lang_course->paymentType === 'percentage' ? 'checked' : ''}}>
                                            <span class="checkmark"></span>
                                        </label>
                                        <input class="inputtext fontp" type="number" name="percentage" min="0" max="100"
                                               value="{{ $lang_course->percentage }}"
                                               placeholder="{{ trans('admin/admin.Percentage (%)') }}"
                                               style="width: 30%; {{ $lang_course->paymentType === 'percentage' ? 'display: block;' : 'display: none;'}}"/>
                                    </div>
                                    ...
                                    <div style="margin-right: 20px;">
                                        <label class="containerRadio">
                                            ...
                                            <input type="radio" name="paymentType" value="perSession"
                                                   required {{ $lang_course->paymentType === 'perSession' ? 'checked' : ''}}>
                                            <span class="checkmark"></span>
                                        </label>
                                        <input class="inputtext fontp" type="number" name="perSession"
                                               value="{{ $lang_course->perSession }}"
                                               placeholder="{{ trans('admin/admin.Fixed salary for all Sessions') }}"
                                               style="width: 40%; {{ $lang_course->paymentType === 'perSession' ? 'display: block;' : 'display: none;'}}"/>
                                    </div>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="level" required>
                                        ...
                                        <option
                                            value="Beginner" {{ $lang_course->getTranslations()['level']['en']  === 'Beginner' ? 'selected' : ''}}>
                                            {{ trans('admin/admin.Beginner') }}
                                        </option>
                                        <option
                                            value="Intermediate" {{ $lang_course->getTranslations()['level']['en'] === 'Intermediate' ? 'selected' : ''}}>
                                            {{ trans('admin/admin.Intermediate') }}
                                        </option>
                                        <option
                                            value="Advanced" {{ $lang_course->getTranslations()['level']['en'] === 'Advanced' ? 'selected' : ''}}>
                                ...
                                <div class=" w-full mt-4">
                                    <p class="font-semibold text-black2 mb-2 text-sm">
                                        {{trans('admin/admin.Level Test Link (google form)') }}
                                    </p>
                                    <input class="inputtext fontp" name="testlink"
                                           placeholder="{{trans('admin/admin.Level Test Link (google form)') }}"
                                           value="{{ $lang_course->testLink }}"/>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <input class="inputtext fontp" type="number" name="numberSessions"
                                           value="{{ $lang_course->numberSessions }}" required
                                ...
                                @php
                                    use Carbon\Carbon;
                                        ...
                                        $frameTime = Carbon::parse($lang_course->frameTime);
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <input class="inputtext fontp" type="number" name="price"
                                           value="{{ $lang_course->price }}" required
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <input class="inputtext fontp" type="date" name="startDate"
                                           ...
                                           value="{{ $lang_course->startDate }}" required/>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="status" required>
                                        ...
                                        <option value="0" {{ $lang_course->status === 0 ? 'selected' : ''}}>
                                            {{ trans('admin/admin.Disabled') }}
                                        </option>
                                        <option value="1" {{ $lang_course->status === 1 ? 'selected' : ''}}>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <textarea
                                        ...
                                        required>{{ $lang_course->getTranslations()['description']['en'] }}</textarea>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <textarea
                                        ...
                                        required>{{ $lang_course->getTranslations()['description']['fr'] }}</textarea>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <textarea
                                        ...
                                        required>{{ $lang_course->getTranslations()['description']['ar'] }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class=" w-full ps-5 md:w-6/12">
                            ...
                            <div class="md:w-3/12 ms-auto">
                                @can('add_student_languages_courses')
                            ...
                            <table class="table admin" datatable id="datatable-search-list">
                                ...
                                @foreach($lang_course->enrollments as $enrollment)
                                    <tr>
                                        ...
                                        <td class="text-sm font-normal leading-normal">
                                            ...
                                            @if($enrollment->endDate >= now())
                                                @can('change_enrollment_status_languages_courses')
                            ...
                            <div class="relative w-full md:w-8/12 mt-10">
                                ...
                                <div class="w-full h-48 overflow-hidden  bg-gray/50 ">
                                    <img id='output' class=" object-cover w-full h-full imagereader"
                                         src="{{ asset('images/courses/'. $lang_course->img) }}" alt="logo"/>
                                </div>
            ...
            <div class="relative bg-white rounded-xl  shadow">
                ...
                <div class="p-6 text-center">
                    ...
                    <form action="{{ route('admin.addStudentToCourse') }}" method="post">
                        ...
                        <input id="studentId" hidden name="courseId" value="{{ $lang_course->id }}" required>
                        <input id="studentId" hidden name="courseType" value="languageCourse" required>
                        ...
                        <div class="w-full mt-10">
                            ...
                            <select class="inputtext" name="group_id" required>
                                ...
                                @foreach($lang_course->groups as $group)
