    ...
    <div class="bg-[#f5f5f5]">
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>{{ trans('admin/admin.Add role') }}</span>
            </h4>

            <form class="w-full" action="{{ route('admin.storeRole') }}" method="post">
                @csrf
                        ...
                        <div class=" w-full md:w-7/12">
                            ...
                            <div class="w-full mt-10">
                                ...
                                <input class="inputtext fontp" type="text" name="name"
                                       placeholder="{{ trans('admin/admin.Role name') }}" required/>
                            </div>
