...
@section('title')
    {{trans('admin/addIntructors.add_instructor')}}
@endsection
...
@section('content')
    <div>
        ...
        <div class="w-full md:ps-24 md:px-10">
            ...
            @endif
            <form class="w-full" onsubmit="return validateForm()" action="{{ route('admin.storeInstructor') }}"
                  method="post"
                ...
                <div class="  w-full bg-white rounded-2xl p-4  py-10 md:px-9">
                    <div class="w-full flex flex-wrap ">
                        <div class=" w-full md:w-7/12 ">
                            ...
                            <div class="w-full mt-10">
                                ...
                                <input class="inputtext fontp" name="firstName" placeholder="{{ trans('admin/addIntructors.first_name') }}" required/>
                            </div>
                            <div class="w-full mt-5">
                                <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.last_name') }}</p>
                                <input class="inputtext fontp" name="lastName" placeholder="{{ trans('admin/addIntructors.last_name') }}" required/>
                            </div>
                            <div class=" flex-wrap flex w-full mt-4">
                                <div class="w-full md:w-6/12 pe-2">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.email') }}</p>
                                    <input class="inputtext fontp" name="email" placeholder="{{ trans('admin/addIntructors.email') }}" required/>
                                </div>
                                <div class=" w-full md:w-6/12 ps-2">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.phone') }}</p>
                                    <input id="phoneInput" class="inputtext fontp" name="phone" placeholder="{{ trans('admin/addIntructors.phone') }}"
                                           required
                            ...
                            <div class=" flex-wrap flex w-full mt-4">
                                <div class="w-full md:w-6/12 pe-2">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.password') }}</p>
                                    <input class="inputtext fontp" type="password" name="password" placeholder="{{ trans('admin/addIntructors.password') }}"
                                           required/>
                                </div>
                                <div class=" w-full md:w-6/12 ps-2">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.confirmation_password') }}</p>
                                    <input class="inputtext fontp" type="password" name="password_confirmation"
                                           placeholder="{{ trans('admin/addIntructors.confirmation_password') }}" required/>
                                </div>
                            </div>

                            <div class=" flex-wrap flex w-full mt-4">
                                <div class="w-full md:w-6/12 pe-2">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.state') }}</p>
                                    <select class="inputtext " name="state">
                                        <option value="" selected
                                                disabled>{{ trans('admin/addIntructors.select_state') }}</option>
                                ...
                                <div class=" w-full md:w-6/12 ps-2">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.address') }}</p>
                                    <input class="inputtext fontp" name="address" placeholder="{{ trans('admin/addIntructors.address') }}" required/>
                                </div>
                            </div>

                            <div class=" w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.Gender') }}</p>
                                <select class="inputtext " name="gender">
                                    <option value="" selected
                                            disabled>{{ trans('admin/addIntructors.select_gender') }}</option>
                                    <option value="male">{{ trans('admin/addIntructors.male') }}</option>
                                    <option value="female">{{ trans('admin/addIntructors.female') }}</option>
                                </select>
                            </div>

                            <div class=" flex-wrap flex w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.status') }}</p>
                                <select class="inputtext " name="status" required>
                                    <option value="" selected
                                            disabled>{{ trans('admin/addIntructors.select_status') }}</option>
                                    <option value="0">{{ trans('admin/addIntructors.disable') }}</option>
                                    <option value="1">{{ trans('admin/addIntructors.active') }}</option>
                                </select>
                            </div>

                            <div class="w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.bio') }}</p>
                                <textarea
                                    ...
                                    rows="3"
                                    placeholder="{{ trans('admin/addIntructors.bio') }}"
                                    name="bio"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit"
                            class=" btn items-center hover:bg-orange3 transform hover:scale-105 ms-0 mt-5 flex px-10">
                        <span class=" text-white font-bold text-sm ">{{ trans('admin/addIntructors.add') }}</span>
                    </button>
                </div>
            </form>
        </div>
