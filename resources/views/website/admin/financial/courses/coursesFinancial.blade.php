...
@section('title')
    {{ trans('admin/admin.CoursesFinancialReport') }}
@endsection
    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>{{ trans('admin/admin.CoursesFinancialReport') }}</span>
            </h4>
                    ...
                    <div>
                        <table class="table admin" datatable id="datatable-search-list">
                            ...
                            <tr class="bg-orange/30">
                                ...
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/admin.Department') }}</th>
                            ...
                            <tbody>
                            @forelse($allSupportingCourses as $course)
                                <tr>
                                    <td>
                                        <div
                            ...
                            @forelse($allIntensiveCourses as $course)
                                <tr>
                                    <td>
                                        <div
                                            class="text-white text-sm flex gap-2 items-center font-semibold w-[100px] ">
                            ...
                            @forelse($allLanguagesCourses as $course)
                                <tr>
                                    <td>
                                        <div
                                            class="text-white text-sm flex gap-2 items-center font-semibold w-[100px] ">
