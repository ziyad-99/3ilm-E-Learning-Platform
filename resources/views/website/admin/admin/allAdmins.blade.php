...
@section('title')
    {{ trans('admin/allAdmins.admins_panel') }}
@endsection
    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl  lg:leading-[120%] ">
                <span>{{ trans('admin/allAdmins.admins_panel') }}</span>
            </h4>
                        ...
                        <div class="border-x-gray/12.5 flex justify-between rounded-t-2xl border-b-0 border-solid p-6">
                            <a href="{{ route('admin.addAdmins') }}"
                               class=" btn items-center mt-5 justify-center hover:bg-orange3 transition-all	 transform hover:scale-[1.01] flex px-6">
                                <span
                                    class=" text-white font-bold text-sm ">{{ trans('admin/allAdmins.add_admin') }}</span>
                            </a>
                        </div>
                    @endcan
                    <div>
                        <table class="table admin" datatable id="datatable-search-list">
                            ...
                            <tr class="bg-orange/30">
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/allAdmins.image') }}</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/allAdmins.name') }}</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/allAdmins.email') }}</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/allAdmins.wilaya') }}</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/addAdmin.role') }}</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">{{ trans('admin/allAdmins.action') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <td class="text-sm font-normal leading-normal">
                                        <div class="relative text-sm group justify-end gap-2 flex font-semibold ">
                                            ...
                                            @if($admin->id != 1)
                                                @can('delete_admins')
                                                    <a id="deleteAdmin"
                                                       href="{{ route('admin.adminDelete', ['admin_id' => $admin->id]) }}"
