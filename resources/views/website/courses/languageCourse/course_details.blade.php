            ...
            <div class="lg:sticky w-full top-1">
                <div class="course-item w-full  rounded-xl bg-white">
                    ...
                    <form
                        ...
                        method="get">
                        @csrf
                        <input hidden name="courseType" value="LanguageCourse">
                    ...
                    @if($course->testLink == null)
                        <a href="#"
                           class="w-full btn mb-2 mt-2 mx-auto items-center hover:bg-orange3 transition-all transform hover:scale-[1.01] justify-center flex px-6">
                        <span
                            class=" text-white font-bold text-sm ">{{ trans('admin/admin.There are no test in this course') }}</span>
                        </a>
                    @else

                        <a href="{{ route('student.testLinkLanguageCourse',['slug'=> $course->slug]) }}"
                           class="w-full btn mb-2 mt-2 mx-auto items-center hover:bg-orange3 transition-all transform hover:scale-[1.01] justify-center flex px-6">
                        <span
