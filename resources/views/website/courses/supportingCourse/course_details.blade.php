                                    ...
                                    <p
                                        ...
                                        <label class="mt-5 containerRadio">
                                            ...
                                            <input type="radio" name="group_selected" value="{{ $group->id }}"
                                                   onclick="openPop('.flexsss24')" form="enrollForm" required>
            ...
            <div data-aos="fade-up" class=" w-full">
                <div class="lg:sticky w-full top-1">
                    <div class="course-item w-full  rounded-xl bg-white">
                        ...
                        {{--                            <span--}}
                        {{--                                class=" text-white font-bold text-sm ">{{ $course->price }} {{ trans('website/suppotingCourseDetails.DA') }}</span>--}}
                        {{--                        </a>--}}
                        ...
                        <form
                            ...
                            method="get">
                            @csrf
                            <input hidden name="courseType" value="supportingCourse">
            ...
            <div class=" flex w-full justify-between">
                ...
                <a href="{{ route('all_supporting_course.index') }}"
                   class="flex justify-center bg-orange hover:bg-orange3 hover:scale-[1.01] transform transition-all rounded-xl px-5 py-2 items-center">
                    <span
                        class="text-sm md:text-sm text-white fontp font-medium">{{ trans('website/suppotingCourseDetails.view_all') }}</span>
                        ...
                        <div class="p-6 text-center">
                            ...
                            <div class="flex items-center justify-center">
                                <label class="mt-5 containerRadio">
                                    ...
                                    <input type="radio" name="monthsNumber" value="1" form="enrollForm">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="mt-5 containerRadio">
                                    <strong>3 {{ trans('admin/admin.Month') }} {{ $course->price * 3 }} {{ trans('admin/admin.(DA)') }}</strong>
                                    <input type="radio" name="monthsNumber" value="3" form="enrollForm">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="mt-5 containerRadio">
                                    <strong>6 {{ trans('admin/admin.Month') }} {{ $course->price * 6 }} {{ trans('admin/admin.(DA)') }}</strong>
                                    <input type="radio" name="monthsNumber" value="6" form="enrollForm">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
