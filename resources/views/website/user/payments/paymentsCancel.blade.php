...
@section('title')
    {{ trans('website/website.Payments Cancel') }}
@endsection
    ...
    <div>
        <div class=" widthfull grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 py-20 justify-between">
            ...
            <div data-aos="fade-up" class="w-full md:col-span-2">
                <h3 class=" font-bold  text-4xl">{{ trans('website/website.Payments Cancel') }}</h3>
                    ...
                    <div data-aos="fade-up" class=" border-b border-[#E2E2E2]/30 px-6 py-5 pt-10">
                        <div class=" flex flex-wrap  items-center">
                            <p
                                ...
                                {{ trans('website/website.Payment number') }} <strong>{{ $invoice->id }}</strong> {{ trans('website/website.with amount') }}
                                <strong>{{ $invoice->amount }} {{ trans('admin/admin.(DA)') }}</strong> {{ trans('website/website.was cancel it') }}
                            </p>
