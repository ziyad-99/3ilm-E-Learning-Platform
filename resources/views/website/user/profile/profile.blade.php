    ...
    <div>
        <div class=" widthfull flex py-5 justify-between">
            <div class="w-full  ">
                ...
                <h3 class=" font-bold text-center text-4xl">{{ trans('website/studentProfile.student_panel') }}</h3>
                <div class=" bg-white flex flex-wrap  boxshadow2 rounded px-0 py-0 mt-10 w-full mx-auto ">
                    ...
                    <div class="w-full md:w-9/12 px-9 py-10">
                        ...
                        <form onsubmit="return validateForm()" action="{{ route('student.updateProfile') }}"
                            ...
                            <div class=" w-full md:w-6/12 mt-6 ">
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="gender">
                                        <option
                                            value="male" {{ $student->gender ==  'male' ? 'selected' : '' }}>{{ trans('website/studentProfile.male') }}</option>
                                        <option
                                            value="female" {{ $student->gender ==  'female' ? 'selected' : '' }}>{{ trans('website/studentProfile.female') }}</option>
                                    </select>
                                </div>

                            </div>
                            <button type="submit"
                                    class=" btn items-center text-white hover:bg-orange3 transition-all mt-5 justify-center flex px-10">
