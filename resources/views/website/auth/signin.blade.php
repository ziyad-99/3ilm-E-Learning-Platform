                ...
                <div class="loginForm" style="margin-top: 4%;" id="student">
                    ...
                    <form method="POST" action="{{ route('login.user') }}">
                        ...
                        <div class=" w-full mt-4">
                            ...
                            <input class="inputtext " type="text" name="email" required autofocus
...
{{--                    </a>--}}
                    ...
                    <a href="{{ route('password.resetPasswordType') }}">
                        <p
...
{{--                    <a href="{{ route('auth.socialite.instructor.redirect','facebook') }}"--}}
                    ...
                    <a href="{{ route('instructor.resetPasswordType') }}">
            ...
            <div class="w-full md:w-[55%]  hidden md:block">
                <div class="w-full">
                    ...
                    <div class="w-full flex justify-center">
                        <span
                            class=" text-orange  w-full font-bold text-4xl text-center ">{{ trans('website/signin.login') }}</span>
                    </div>
                </div>
            </div>
        </div>
