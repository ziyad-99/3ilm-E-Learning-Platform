        ...
        <div class=" widthfull flex flex-wrap py-20 justify-between">
            <div class="w-full md:ps-20 md:w-[40%] ">
                ...
                <p class=" text-gray2 fontp font-normal text-base leading-[135%] my-6 text-start">
                    {{ trans('auth.please entre the code you have received via sms on you number') }}, {{ $phone }} .
                </p>

                <a href="{{ route('instructor.generateNewCode', ['phone' => $phone]) }}">
                ...
                <form action="{{ route('instructor.verifyRestPasswordCode') }}" method="get">
                    @csrf
