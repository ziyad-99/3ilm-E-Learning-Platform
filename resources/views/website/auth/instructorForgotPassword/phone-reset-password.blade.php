    ...
    <div>
        <div class=" widthfull flex flex-wrap py-20 justify-between">
            <div class="w-full md:ps-20 md:w-[40%] ">
                ...
                <form action="{{ route('instructor.phoneResetPassword') }}" method="get">
                    @csrf
                    ...
                    <div class=" w-full mt-5">
                        ...
                        <input class="inputtext " placeholder="{{ trans('auth.New Password') }}" type="password" name="password" required/>
                    </div>

                    <div class=" w-full mt-5">
                        <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('auth.Confirmation New Password') }}</p>
                        <input class="inputtext " placeholder="{{ trans('auth.Confirmation New Password') }}" type="password"
