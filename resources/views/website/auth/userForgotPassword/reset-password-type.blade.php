        ...
        <div class=" widthfull flex flex-wrap py-20 justify-between">
            <div class="w-full md:ps-20 md:w-[40%] ">
                ...
                <p class=" text-gray2 fontp font-normal text-base leading-[135%] my-6 text-start">
                    {{ trans('auth.Please choose the method you want to reset your password') }}
                </p>
                ...
                <form action="{{ route('password.chooseResetPasswordType') }}" method="get">
                    @csrf

                    <label class="containerRadio">
                        {{ trans('auth.Via Email') }}
                        <input type="radio" name="restType" value="email" required>
                        <span class="checkmark"></span>
                    </label>

                    <label class="containerRadio">
                        {{ trans('auth.Via Phone Number') }}
                        <input type="radio" name="restType" value="phone_number" required>
                        <span class="checkmark"></span>
                    </label>
                    ...
                    <button
                        ...
                        <span class=" text-white font-bold text-sm ">{{ trans('auth.Rest my Password') }}</span>
                    </button>
                </form>
